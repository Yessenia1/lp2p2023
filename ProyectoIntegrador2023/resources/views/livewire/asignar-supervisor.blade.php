<x-app-layout>
    <div class="w-full h-[100px] bg-blue-950 flex justify-center items-center">
        <div class="ValidarInforme w-[449px] h-[50px] text-center text-white text-[40px] font-normal font-['Inter']">
            Asignar Supervisor
        </div>
    </div>
    ...
    <div class="modal fade" id="modalAsignarSupervisor" tabindex="-1" aria-labelledby="modalAsignarSupervisorLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" style="background-color: #6c757d; color: #fff; border-color: #6c757d;"
                            onmouseover="this.style.backgroundColor='#dc3545'; this.style.borderColor='#dc3545'; this.style.color='#fff';"
                            onmouseout="this.style.backgroundColor='#6c757d'; this.style.borderColor='#6c757d'; this.style.color='#fff';"
                            data-bs-dismiss="modal">Cancelar</button>
                        <button id="guardarSupervisor" type="button" class="btn btn-primary" style="background-color: #0d6efd; color: #fff; border-color: #0d6efd;"
                            onmouseover="this.style.backgroundColor='#dc3545'; this.style.borderColor='#dc3545';"
                            onmouseout="this.style.backgroundColor='#0d6efd'; this.style.borderColor='#0d6efd';">Guardar</button>
                    </div>
