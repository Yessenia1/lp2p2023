        ...
        <div class="flex items-center justify-center">
            <div class="rounded-lg">
                <div class="flex space-x-4 justify-center mb-5">
                    ...
                    <a href="{{ url('pdff') }}"  class="text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                        descargas<img src="img/descargar.png" alt="" style="width: 30px;">
                    </a>
                </div>
            </div>
        </div>
